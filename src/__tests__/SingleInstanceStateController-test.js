...
describe("SingleInstanceStateController", () => {
  ...
  it("can enqueue a chain of tasks", async () => {
    ...
    SingleInstanceStateController.enqueueTask(
      { className: "someClass", id: "M" },
      () => {
        return p1.then(() => {
          called[0] = true;
        });
