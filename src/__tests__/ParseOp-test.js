...
describe("ParseOp", () => {
  ...
  it("can create and apply AddUnique Ops", () => {
    ...
    merge = new AddUniqueOp(["an", "element"]).mergeWith(
      new AddUniqueOp([1, 2, "element", 3])
    );
    expect(merge instanceof AddUniqueOp).toBe(true);
  ...
  it("can create and apply Relation Ops", () => {
    ...
    expect(
      r3.applyTo.bind(r3, rel, { className: "Delivery", id: "D3" }, "packages")
