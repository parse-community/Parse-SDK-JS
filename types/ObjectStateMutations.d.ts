...
export declare function popPendingState(pendingOps: Array<OpsMap>): OpsMap | undefined;
export declare function mergeFirstPendingState(pendingOps: Array<OpsMap>): void;
export declare function estimateAttribute(serverData: AttributeMap, pendingOps: Array<OpsMap>, className: string, id: string | undefined, attr: string): any;
export declare function estimateAttributes(serverData: AttributeMap, pendingOps: Array<OpsMap>, className: string, id?: string): AttributeMap;
