declare namespace Parse {
  ...
  class Cloud {
     ...
     * of the function.</p>
     */
    static run(name: string, data?: any, options?: RequestOptions): Promise<any>;
    /**
    ...
    static define(
      name: string,
      func: Parse.Cloud.FunctionRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.FunctionRequestFunc
    ): void;
    /**
     ...
     */
    static afterDelete(
      ParseClass: string | Parse.Object,
      func: Parse.Cloud.TriggerRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.TriggerRequestFunc
    ): void;
    /**
    ...
    static beforeFind(
      ParseClass: string | Parse.Object,
      func: Parse.Cloud.BeforeFindRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.BeforeFindRequestFunc
    ): void;
    /**
    ...
    static afterFind(
      ParseClass: string | Parse.Object,
      func: Parse.Cloud.AfterFindRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.AfterFindRequestFunc
    ): void;
    /**
     ...
     * @param [validator] - <p>An optional function to help validating cloud code.</p>
     */
    static beforeSaveFile(
      func: Parse.Cloud.FileTriggerRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.FileTriggerRequestFunc
    ): void;
    /**
    ...
    static beforeConnect(
      func: Parse.Cloud.ConnectTriggerRequestFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.ConnectTriggerRequestFunc
    ): void;
    /**
     ...
     * @param [validator] - <p>An optional function to help validating cloud code.</p>
     */
    static afterLiveQueryEvent(
      ParseClass: string | Parse.Object,
      func: Parse.Cloud.LiveQueryEventTriggerFunc,
      validator?: Parse.Cloud.ValidatorObject | Parse.Cloud.LiveQueryEventTriggerFunc
    ): void;
    /**
  ...
  namespace Cloud {
     ...
     * @param request - <p>The request object</p>
     */
    type FunctionRequestFunc = (request: Parse.Cloud.FunctionRequest) => void;
    /**
     * @property [installationId] - <p>If set, the installationId triggering the request.</p>
     * @property master - <p>If true, means the master key was used.</p>
     * @property [user] - <p>If set, the user that made the request.</p>
  ...
  class File {
     ...
     * @param [options.forceSecure] - <p>Force secure</p>
     */
     ...
     */
    save(options?: FullOptions): Promise<Parse.File>;
    /**
     ...
     */
    destroy(options?: FullOptions): Promise<Parse.File>;
    /**
     * <p>Returns a JSON representation of this file.</p>
     * @returns <p>The JSON representation of the file.</p>
     */
    toJSON(): any;
    /**
   ...
   * @param [options.ignoreValidation] - <p>Ignore validation</p>
   */
  class Object<T extends Attributes = Attributes> {
     ...
     * completes.</p>
     */
    fetch(options?: RequestOptions): Promise<this>;
    /**
     * <p>Fetch the model from the server. If the server's representation of the
     * model differs from its current attributes, they will be overriden.</p>
     ...
     */
    save(
      arg1?: string | any | null,
      arg2?: string | SaveOptions,
      arg3?: SaveOptions
    ): Promise<this>;
    /**
  ...
  class Query<T extends Object = Object> {
     ...
     */
    get(objectId: string, options?: QueryOptions): Promise<Parse.Object>;
    /**
     ...
     * the query completes.</p>
     */
    find(options?: QueryOptions): Promise<Parse.Object[]>;
    /**
     ...
     * the query completes.</p>
     */
    findAll(options?: BatchOptions): Promise<Parse.Object[]>;
    /**
     * <p>Counts the number of objects that match this query.</p>
     * @param [options.sessionToken] - <p>Valid options are:<ul></p>
     *   <li>useMasterKey: In Cloud Code and Node only, causes the Master Key to
     *     be used for this request.
     *   <li>sessionToken: A valid session token, used for making a request on
     *       behalf of a specific user.
     ...
     * the query completes.</p>
     */
    first(options?: QueryOptions): Promise<Parse.Object>;
    /**
     ...
     */
    eachBatch(callback: (...params: any[]) => any, options?: BatchOptions): Promise<void>;
    /**
     ...
     * iteration has completed.</p>
     */
    each(callback: (...params: any[]) => any, options?: BatchOptions): Promise<void>;
    /**
     ...
     * iteration has completed.</p>
     */
    map(callback: (...params: any[]) => any, options?: BatchOptions): Promise<any[]>;
    /**
     * <p>Iterates over each result of a query, calling a callback for each one. If
     * the callback returns a promise, the iteration will not continue until
     * that promise has been fulfilled. If the callback returns a rejected
     ...
     * </ul>
     * @param [options] - <p>batch options</p>
     * @returns <p>A promise that will be fulfilled once the
     * iteration has completed.</p>
     */
    filter(callback: (...params: any[]) => any, options?: BatchOptions): Promise<Parse.Object[]>;
    /**
     ...
     * @param [options] - <p>The full text options</p>
     * @returns <p>Returns the query, so you can chain this call.</p>
     */
   ...
   * cloud.</p>
   */
  class Role extends Parse.Object {
  ...
  class User extends Parse.Object {
     ...
     * finishes.</p>
     */
    _unlinkFrom(provider: string | AuthProvider, options?: FullOptions): Promise<Parse.User>;
    /**
     ...
     */
    logIn(options?: FullOptions): Promise<Parse.User>;
    /**
     ...
     */
    static logIn(username: string, password: string, options?: FullOptions): Promise<Parse.User>;
    /**
     ...
     * the login completes.</p>
     */
    static become(sessionToken: string, options?: RequestOptions): Promise<Parse.User>;
    /**
...
declare type AnalyticsController = {
  track: AnalyticsControllerTrackCallback;
};

declare type AnalyticsControllerTrackCallback = (
  name: string,
  dimensions?: {
    [key: string]: string;
  }
...
declare type CloudController = {
  run: CloudControllerRunStart;
  getJobsData: CloudControllerGetJobsData;
  startJob: CloudControllerRunStart;
};

declare type CloudControllerRunStart = (
  name: string,
  data?: any,
  options?: RequestOptions
) => Promise<any>;

declare type CloudControllerGetJobsData = (options?: RequestOptions) => Promise<any>;
 ...
 */
declare function matchesKeyConstraints(
  className: any,
  object: any,
  objects: any,
  key: any,
...
declare class Parse {
   ...
   * This must be called after <code>Parse.initialize</code> in your application.</p>
   * @param [polling] - <p>Allow pinging the server /health endpoint. Default true</p>
   * @param [ms] - <p>Milliseconds to ping the server. Default 2000ms</p>
   */
...
/**
 * <p>Typedef for SaveParams</p>
 * @property [cascadeSave] - <p>cascadeSave</p>
 * @property [content] - <p>context</p>
 */
...
declare type SaveOptions = FullOptions | SaveParams;
...
/**
 * <p>Typedef for QueryOptions</p>
 * @property [useMasterKey] - <p>If true, sign up with masterKey</p>
 * @property [sessionToken] - <p>sessionToken</p>
 * @property [context] - <p>context</p>
 * @property [json] - <p>json</p>
 */
...
/**
 * <p>Typedef for BatchOptions</p>
 * @property [useMasterKey] - <p>If true, sign up with masterKey</p>
 * @property [sessionToken] - <p>sessionToken</p>
 * @property [context] - <p>context</p>
 * @property [batchSize] - <p>batchSize</p>
 */
...
/**
 * <p>Typedef for Aggregation Options</p>
 */
declare type AggregationPipeline = {
  group?: Attributes | GroupParams;
  match?: Attributes;
  project?: Attributes;
  limit?: number;
  skip?: number;
...
/**
 * <p>Typedef for Aggregate Group</p>
 */
declare type GroupParams = {
  objectId?: string;
};

/**
 * <p>Typedef for Full Text Options</p>
 * @property language - <p>The language that determines the list of stop words for the search and the rules for the stemmer and tokenizer.</p>
 * @property caseSensitive - <p>A boolean flag to enable or disable case sensitive search.</p>
 * @property diacriticSensitive - <p>A boolean flag to enable or disable diacritic sensitive search.</p>
 */
declare type FullTextOptions = {
  language: string;
...
/**
 * <p>Typedef for FieldOptions</p>
 * @property [required] - <p>Whether the field is required</p>
 * @property [defaultValue] - <p>Default value for the field</p>
 */
...
/**
 * <p>Typedef for RequestOptions</p>
 * @property [useMasterKey] - <p>If true, sign up with masterKey</p>
 * @property [sessionToken] - <p>sessionToken</p>
 * @property [installationId] - <p>InstallationId of user</p>
 * @property [returnStatus] - <p>return status</p>
 * @property [batchSize] - <p>batch size</p>
 * @property [include] - <p>include</p>
 * @property [context] - <p>context</p>
 * @property [usePost] - <p>whether request should use POST</p>
 */
...
/**
 * <p>Typedef for FullOptions</p>
 * @property [useMasterKey] - <p>If true, sign up with masterKey</p>
 * @property [sessionToken] - <p>sessionToken</p>
 * @property [installationId] - <p>InstallationId of user</p>
 * @property [progress] - <p>progress</p>
 * @property [usePost] - <p>whether request should use POST</p>
 */
...
interface BeforeFindRequest<T extends Parse.Object = Parse.Object>
  extends GenericTriggerRequest<T> {
  query: Parse.Query<T>;
}
