...
declare const Parse: {
    ...
    CoreManager: {
        ...
        setEventuallyQueue(controller: {
            save: (object: ParseObject, serverOptions: import("./ParseObject").SaveOptions) => Promise<any>;
            destroy: (object: ParseObject, serverOptions: import("./RESTController").RequestOptions) => Promise<any>;
            poll: (ms?: number) => void;
        }): void;
        getEventuallyQueue(): {
            save: (object: ParseObject, serverOptions: import("./ParseObject").SaveOptions) => Promise<any>;
